...
- (void) runBobbingAction
{
    ...
    CCMoveBy *moveUp = [CCMoveBy actionWithDuration:1.5f position:ADJUST_IPAD_CCP(ccp(0, 10))];
    CCEaseOut *easeUp = [CCEaseIn actionWithAction:moveUp rate:1.5f];
    CCMoveBy *moveDown = [CCMoveBy actionWithDuration:1.25f position:ADJUST_IPAD_CCP(ccp(0, -10))];
